...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cw="http://schemas.microsoft.com/sharepoint/soap/" xmlns:rs="urn:schemas-microsoft-com:rowset" xmlns:z="#RowsetSchema" exclude-result-prefixes="xs cw rs z">
  ...
  <xsl:template match="/">
	...
	<div id="taskDelete" class="cw-hide" style="padding: 15px">
	<span>Are you sure you want to delete this task?<br/>Press YES to delete the task. Press NO to cancel.</span>
    ...
    <div id="tasksDataView" class="cw-hide">
              ...
              <div id="legend">
                ...
                <div class="legend-container">
                  <div class="legend-items">
                    ...
                    <img src="[SRA Root]/resources/TaskBoard_2/Images/star_red.png" />High Priority<br />
