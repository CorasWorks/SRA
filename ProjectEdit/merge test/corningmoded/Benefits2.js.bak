...
$(document).ready(function () {
	...
	*/
	...
	$('#BenefitsYearBody').on('change','.FinancialCategoriesSelectBox',function(){    
		FinancialChange($("option:selected", this).data('id'), $(this), YearTotalNeeded );
	...
	$('#BenefitsMonthBody').on('change','.FinancialCategoriesSelectBox',function(){    
		FinancialChange($("option:selected", this).data('id'), $(this), MonthTotalNeeded );
	        ...
	        success: function (json) {
		        var LocationItems="";
					if (json.NewDataSet.Subcategories.listitems["rs:data"].ItemCount == 0){
						...
						LocationItems+='<option selected="selected" disabled="disabled"></option>';
						LocationItems+='<optiondata-id="'+json.NewDataSet.Subcategories.listitems["rs:data"]["z:row"].ows_ID+'" value="'+json.NewDataSet.Subcategories.listitems["rs:data"]["z:row"].ows_Title+'">'+json.NewDataSet.Subcategories.listitems["rs:data"]["z:row"].ows_Title+'</option>'; 
					}					
					else{
						LocationItems+='<option selected="selected" disabled="disabled"></option>';
