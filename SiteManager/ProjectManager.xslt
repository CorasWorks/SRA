...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cw="http://schemas.microsoft.com/sharepoint/soap/" xmlns:rs="urn:schemas-microsoft-com:rowset" xmlns:z="#RowsetSchema" exclude-result-prefixes="xs cw rs z">
	...
	<div id="PCDisplayRoot">
		<div id="ProjectManagerLoader" style="text-align: center; display:none">
		...
		<div id="ProjectManagerShell">
			<div id="ProjectManagerWrap">
				<!-- pager -->
				<div id="PCDocumentsPager" class="pagerProjectManager">
				  <form>
				...
				<table id="ProjectManager" class="tablesorter-default">
				  <thead>
				    <tr>
 				  ...
 				  -->
					...
					<xsl:variable name="EditSite">
						...
						<tr>
							...
							<xsl:variable name="PSID" select="@ows_ProjectStatusID"/>
							<td><xsl:value-of select="//ProjectStatuses/cw:listitems/rs:data/z:row[@ows_ID = $PSID]/@ows_Title" /></td>
							<!--
