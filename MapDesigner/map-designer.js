//TODO: removeProp may cause problems, look into another way to clear the multi-select
...
// by: papproth, brian
// date: 2015.04.07
// purpose: initial function call after page loads
...
function getMaps(callback) {
    ...
    $.ajax({
        ...
        data: { 'RequestType': 'BatchRequest', 'ConfigFileLocation': '[SRA Root]/resources/MapDesigner/map-designerCBD.xml', 'OutputType': 'JSON', 'XsltLocation': '[SRA Root]/Resources/MapDesigner/mapDesignerXSLT.xslt' },
        dataType: 'json',
        async: true,
        cache: false,
        type: 'POST',
...
function getDeliverables(callback) {
    ...
    $.ajax({
        ...
        data: {
            'RequestType': 'BatchRequest',
            'ConfigFileLocation': '[SRA Root]/Resources/MapDesigner/getAllDeliverablesCBD.xml',
            'OutputType': 'json',
            'XsltLocation': '[SRA Root]/Resources/MapDesigner/getAllDeliverablesXSLT.xslt'
        },
        dataType: 'json',
        async: true,
        cache: false,
...
function getKeyQuestions(callback) {
    ...
    $.ajax({
        ...
        data: {
            'RequestType': 'BatchRequest',
            'ConfigFileLocation': '[SRA Root]/Resources/MapDesigner/getAllQuestionsCBD.xml',
            'OutputType': 'json',
            'XsltLocation': '[SRA Root]/Resources/MapDesigner/getAllQuestionsXSLT.xslt'
        },
        dataType: 'json',
        async: true,
        cache: false,
...
function getTemplates(callback) {
    ...
    $.ajax({
        ...
        data: {
            'RequestType': 'BatchRequest',
            'ConfigFileLocation': '[SRA Root]/Resources/MapDesigner/getToolsAndTemplatesCBD.xml',
            'OutputType': 'json',
            'XsltLocation': '[SRA Root]/Resources/MapDesigner/getToolsAndTemplatesXSLT.xslt'
        },
        dataType: 'json',
        async: true,
        cache: false,
