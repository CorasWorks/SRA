					...
					<project_chart>
						<tasks>
							<xsl:for-each select="//NewDataSet/*/NewDataSet/Tasks[cw:listitems/rs:data/z:row/@ows_IsSummaryTask = '0']">
								...
								<xsl:variable name="siteTitle" select="//NewDataSet/*/NewDataSet/SiteDirectory/cw:listitems/rs:data/z:row[@ows_URL = $siteURL]/@ows_Title" />
								...
								<task parent="">
									...
									<style>
										...
										<tooltip>
											...
											<text>
 		Project: <xsl:value-of select="$siteTitle" /> (<xsl:value-of select="$thisSiteDirectory/@ows_URL" />)
			...
			<xsl:text>&#160;</xsl:text>
									...
									<attributes>
										<attribute name="SiteURL">
											<xsl:value-of select="$thisSiteDirectory/@ows_URL" />
										</attribute>
									...
									<actions>
										<action type="NavigateToURL" event="Click" target="_top">
											<xsl:attribute name="url">
												<xsl:value-of select="$thisSiteDirectory/z:row/@ows_URL" />
											</xsl:attribute>
										</action>
									</actions>
								</task>
