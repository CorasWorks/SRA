...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:date="http://exslt.org/dates-and-times" xmlns:cw="http://schemas.microsoft.com/sharepoint/soap/" xmlns:rs="urn:schemas-microsoft-com:rowset" xmlns:z="#RowsetSchema" exclude-result-prefixes="msxsl date cw rs z">
	...
	<xsl:template match="/">
		...
		<OperationDefinitionCollection>
			<Items>
				...
				<OperationDefinition>
					<RequestType>GetListItems</RequestType>
					<TableName>KPILabels</TableName>
					<ListTitle>KPI Labels</ListTitle>
					<SiteUrl>[PPM v3.2]</SiteUrl>
				</OperationDefinition>
			</Items>
		</OperationDefinitionCollection>
