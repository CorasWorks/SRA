...
$('#ProjectApprovalsMain').hide();
	$.ajax({
		...
		data : {
			...
			ConfigFileLocation: '[SRA Root]/Resources/MainApprovalsDisplay/ProjectApprovalSingle.xml',
			APID: getParameterByName('APID'), 
			XsltLocation: '[SRA Root]/Resources/MainApprovalsDisplay/ProjectApprovalSingle.xslt',
			OutputType : 'html'
		},
