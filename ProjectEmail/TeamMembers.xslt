                ...
                <div id="ResourcesBody">
					  ...
					  <tbody id="ProCostsYearBody">
						<xsl:for-each-group select="$ProjectCostLocal/z:row" group-by="@ows_Title">	              
			                <tr data-id="New" data-column="ExpenseTarget">
						      ...
						      <td>
						      	<input type="text" data-column="Year" value="{current-grouping-key()}" disabled="disabled" />
						      </td>					    
						      <td>
						      	<input type="text" data-column="ExpenseTarget" value="{sum($ProjectCostLocal/z:row[@ows_Title=current-grouping-key()]/@ows_ExpenseTarget)}">
						      ...
						      <td>
						      	<input type="text" data-column="ExpenseActual" value="{sum($ProjectCostLocal/z:row[@ows_Title=current-grouping-key()]/@ows_ExpenseActual)}">
						      		<xsl:if test="$PCFinancialEntryType='Month'">
									<xsl:attribute name="disabled">disabled</xsl:attribute>
									</xsl:if>
						      	</input>
						      ...
						      <td>
						      	<input type="text" data-column="CapitalTarget" value="{sum($ProjectCostLocal/z:row[@ows_Title=current-grouping-key()]/@ows_CapitalTarget)}">
						      		<xsl:if test="$PCFinancialEntryType='Month'">
									<xsl:attribute name="disabled">disabled</xsl:attribute>
									</xsl:if>
						      	</input>
						      ...
						      <td>
						      	<input type="text" data-column="CapitalActual" value="{sum($ProjectCostLocal/z:row[@ows_Title=current-grouping-key()]/@ows_CapitalActual)}">
						      		<xsl:if test="$PCFinancialEntryType='Month'">
									<xsl:attribute name="disabled">disabled</xsl:attribute>
									</xsl:if>
						      	</input>
					...
					<table id="ProCostsMonth" class="tablesorter-default">
					  ...
					  <xsl:for-each select="//ProjectCostLocal/cw:listitems/rs:data/z:row">
					    ...
					    <tr data-id="New" data-column="ExpenseTarget">				    
					      <td>
					      	<input type="text" data-column="Year" value="{@ows_Title}" disabled="disabled" />
					      </td>
					      <td>
					      	<input type="text" data-column="Month" value="{@ows_Month}" disabled="disabled" />
					      </td>						      					    
					      <td>
					      	<input type="text" data-column="ExpenseTarget" value="{$ExpenseTarget}" />
					      </td>
					      <td>
					      	<input type="text" data-column="ExpenseActual" value="{$ExpenseActual}" />
					      </td>
					      <td>
					      	<input type="text" data-column="CapitalTarget" value="{$CapitalTarget}" />
					      </td>
					      <td>
					      	<input type="text" data-column="CapitalActual" value="{$CapitalActual}" />
					      </td>
					    </tr> 
					    </xsl:for-each>				  
					  </tbody>
