...
<xsl:stylesheet version="1.0" 
			...
			<view type="Dashboard">
				...
				<vbox width="100%" height="100%">
					...
					<hbox width="100%" height="50%">
						<margin all="0" />
						<view type="Chart" source="TasksByPriority" width="33%" height="100%" />
						<view type="Chart" source="TasksByStatus" width="33%" height="100%" />
						<view type="Chart" source="WorkHours" width="33%" height="100%" />
					</hbox>
					<hbox width="100%" height="50%">
						<margin all="0" />
						<view type="Chart" source="OverdueTasks" width="50%" height="100%" />
						<view type="Chart" source="TasksByAssignedTo" width="50%" height="100%" />
					</hbox>
				</vbox>
			</view>
		</dashboard>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<chart name="TasksByPriority" template="baseTemplatePie" plot_type="Pie">
					...
					<data>
						<actions>
							<action type="call" function="clickOnTasksByPriority">
								<arg>{%Priority}</arg>
								<arg>{%CurrentSite}</arg>
								<arg>{%SRARoot}</arg>
							</action>
							...
							<xsl:for-each select="//NewDataSet/TasksMetadata/cw:List/cw:Fields/cw:Field[@Name='Priority']/cw:CHOICES/cw:CHOICE">
								...
								<point>
									...
									<attributes>
										...
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
									</attributes>
								</point>
							</xsl:for-each>
						</series>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<chart name="TasksByStatus" template="baseTemplatePie" plot_type="Pie">
					...
					<data>
						<actions>
							<action type="call" function="clickOnTasksByStatus">
								<arg>{%Status}</arg>
								<arg>{%CurrentSite}</arg>
								<arg>{%SRARoot}</arg>
							</action>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<chart name="WorkHours" template="baseTemplateCategorizedVertical" plot_type="CategorizedVertical">
					...
					<data>
						<actions>
							<action type="call" function="clickOnWork">
								<arg>{%Name}</arg>
								<arg>{%CurrentSite}</arg>
								<arg>{%SRARoot}</arg>
							</action>
	...
	<xsl:template name="ExpensesChart">
		<xsl:choose>
			<xsl:when test="sum(//NewDataSet/ExpenseTrackingCategories/cw:listitems/rs:data/z:row/@ows_BudgetedAmount) = 0 and sum(//NewDataSet/ExpenseTracking/cw:listitems/rs:data/z:row/@ows_Amount) = 0">
			...
			<xsl:otherwise>
				<chart name="Expenses" template="baseTemplateCategorizedVertical" plot_type="CategorizedVertical">
					...
					<data>
						<actions>
							<action type="call" function="clickOnExpense">
								<arg>{%Name}</arg>
							</action>
						</actions>
						<series name="Budgeted">
							<point name="Budgeted">
								<xsl:attribute name="y">
									<xsl:value-of select="sum(//NewDataSet/ExpenseTrackingCategories/cw:listitems/rs:data/z:row/@ows_BudgetedAmount)" />
								</xsl:attribute>
							</point>
						</series>
						<series name="Actual">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<chart name="TasksByAssignedTo" template="baseTemplateCategorizedVertical" plot_type="CategorizedHorizontal">
					...
					<data>
						<actions>
							<action type="call" function="clickOnAssignedTo">
								<arg>{%Name}</arg>
								<arg>{%CurrentSite}</arg>
								<arg>{%SRARoot}</arg>
							</action>
						...
						<xsl:for-each select="$assignedTo/AssignedTo">
							...
							<series>
								<point>
									...
									<xsl:attribute name="y">
										<xsl:value-of select="count($tasksData/z:row[contains(@ows_AssignedTo, $Key)])" />
									</xsl:attribute>
									<attributes>
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
			...
			<data>
				...
				<series name="Incomplete">
					<point name="Slight">
						...
						<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And><Neq><FieldRef Name='Status'/><Value Type='Choice'>Completed</Value></Neq><Eq><FieldRef Name="IsSummaryTask"/><Value Type="Boolean">0</Value></Eq></And><And><Geq><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-7'/></Value></Geq><Lt><FieldRef Name='DueDate'/><Value Type='DateTime'><Today/></Value></Lt></And></And></Where></Query>]]></attribute>
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
						</attributes>
					</point>
					<point name="Moderate">
						...
						<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And></And><Neq><FieldRef Name='Status'/><Value Type='Choice'>Completed</Value></Neq><And><Geq><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-14'/></Value></Geq><Lt><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-7'/></Value></Lt></And><Eq><FieldRef Name="IsSummaryTask"/><Value Type="Boolean">0</Value></Eq></And></Where></Query>]]></attribute>
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
						</attributes>
					</point>
					<point name="Extreme">
						...
						<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And><Neq><FieldRef Name='Status'/><Value Type='Choice'>Completed</Value></Neq><Lt><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-14'/></Value></Lt></And><Eq><FieldRef Name="IsSummaryTask"/><Value Type="Boolean">0</Value></Eq></And></Where></Query>]]></attribute>
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
						</attributes>
					</point>
				...
				<series name="Unstarted">
					<point name="Slight">
						...
						<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And><Eq><FieldRef Name='Status'/><Value Type='Choice'>Not Started</Value></Eq><Eq><FieldRef Name="IsSummaryTask"/><Value Type="Boolean">0</Value></Eq></And><And><Geq><FieldRef Name='StartDate'/><Value Type='DateTime'><Today OffsetDays='-7'/></Value></Geq><Lt><FieldRef Name='StartDate'/><Value Type='DateTime'><Today /></Value></Lt></And></And></Where></Query>]]></attribute>
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
						</attributes>
					</point>
					...
					<point name="Extreme">
						...
						<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And><Eq><FieldRef Name='Status'/><Value Type='Choice'>Not Started</Value></Eq><Lt><FieldRef Name='StartDate'/><Value Type='DateTime'><Today OffsetDays='-14'/></Value></Lt></And><Eq><FieldRef Name="IsSummaryTask"/><Value Type="Boolean">0</Value></Eq></And></Where></Query>]]></attribute>
										<attribute name="CurrentSite">%ISiteURL%</attribute>
										<attribute name="SRARoot">[SRA Root]</attribute>
						</attributes>
					</point>
