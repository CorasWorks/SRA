			...
			<dashboard>
				<view type="Dashboard">
					...
					<vbox width="100%" height="100%">
						...
						<hbox width="100%" height="50%">
							<margin all="0" />
							<view type="Chart" source="OverdueTasks" width="75%" height="100%" />
									...
									<xsl:for-each select="//NewDataSet/TasksMetadata/cw:List/cw:Fields/cw:Field[@Name='Priority']/cw:CHOICES/cw:CHOICE">
										...
										<point>
											...
											<attributes>
												...
												<attribute name="CurrentUser">[Me]</attribute>
											</attributes>
										</point>
									</xsl:for-each>
								</series>
					...
					<data>
						...
						<series name="Incomplete">
							...
							<point name="Moderate">
								...
								<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And></And><And><And><Neq><FieldRef Name='Status'/><Value Type='Choice'>Completed</Value></Neq><Eq><FieldRef Name='AssignedTo'/><Value Type='User'>Me</Value></Eq></And><And><Geq><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-14'/></Value></Geq><Lt><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-7'/></Value></Lt></And></And><Eq><FieldRef Name='IsSummaryTask'/><Value Type='Boolean'>0</Value></Eq></And></Where></Query>]]></attribute>
												<attribute name="CurrentSite">%ISiteURL%</attribute>
												<attribute name="SRARoot">[SRA Root]</attribute>
												<attribute name="CurrentUser">[Me]</attribute>
								</attributes>
							...
							<point name="Extreme">
								...
								<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And><Neq><FieldRef Name='Status'/><Value Type='Choice'>Completed</Value></Neq><Lt><FieldRef Name='DueDate'/><Value Type='DateTime'><Today OffsetDays='-14'/></Value></Lt></And><And><Eq><FieldRef Name='AssignedTo'/><Value Type='User'>Me</Value></Eq><Eq><FieldRef Name='IsSummaryTask'/><Value Type='Boolean'>0</Value></Eq></And></And></Where></Query>]]></attribute>
												<attribute name="CurrentSite">%ISiteURL%</attribute>
												<attribute name="SRARoot">[SRA Root]</attribute>
												<attribute name="CurrentUser">[Me]</attribute>
								</attributes>
						...
						<series name="Unstarted">
							...
							<point name="Extreme">
								...
								<attributes>
									<attribute name="Query"><![CDATA[<Query><Where><And><And><Eq><FieldRef Name='Status'/><Value Type='Choice'>Not Started</Value></Eq><Lt><FieldRef Name='StartDate'/><Value Type='DateTime'><Today OffsetDays='-14'/></Value></Lt></And><And><Eq><FieldRef Name='AssignedTo'/><Value Type='User'>Me</Value></Eq><Eq><FieldRef Name='IsSummaryTask'/><Value Type='Boolean'>0</Value></Eq></And></And></Where></Query>]]></attribute>
												<attribute name="CurrentSite">%ISiteURL%</attribute>
												<attribute name="SRARoot">[SRA Root]</attribute>
												<attribute name="CurrentUser">[Me]</attribute>
								</attributes>
