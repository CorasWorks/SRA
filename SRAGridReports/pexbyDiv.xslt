...
-->
			...
			<xsl:choose>
				<xsl:when test="$thisDiv != ''">
						<Data>
							...
							<Location></Location>
							<Project></Project>
							<YearGroup><xsl:value-of select="$thisYear"/>-<xsl:value-of select="max($FinancialsGroupedbyProject/Data[Division/@id = $thisDiv and TargetSum1Yr &gt; 0 and TargetSum1Yr &gt; 0]/Year)"/></YearGroup>
							<Year><xsl:value-of select="$thisYear"/>-<xsl:value-of select="max($FinancialsGroupedbyProject/Data[Division/@id = $thisDiv and TargetSum1Yr &gt; 0 and TargetSum1Yr &gt; 0]/Year)"/></Year>
				...
				<xsl:otherwise>
					<Data>
						...
						<Location></Location>
						<Project></Project>
						<YearGroup><xsl:value-of select="$thisYear"/>-<xsl:value-of select="max($FinancialsGroupedbyProject/Data[TargetSum1Yr &gt; 0 and TargetSum1Yr &gt; 0]/Year)"/></YearGroup>
						<Year><xsl:value-of select="$thisYear"/>-<xsl:value-of select="max($FinancialsGroupedbyProject/Data[TargetSum1Yr &gt; 0 and TargetSum1Yr &gt; 0]/Year)"/></Year>
						<ActiveProjects>-</ActiveProjects>
						<CompletedProjects>-</CompletedProjects>
						<ActiveProjectsSplit>-</ActiveProjectsSplit>
						<CompletedProjectsSplit>-</CompletedProjectsSplit>
		...
		<NewDataSet>
			<!--<xsl:copy-of select="$Benefits"/>-->
			<xsl:for-each select="if('%CurrentYear%' = '1') then $FinancialsGroupedbyDivision/Data[contains(Year,$thisYear) and not(contains(Division,'All'))] else $FinancialsGroupedbyDivision/Data">
